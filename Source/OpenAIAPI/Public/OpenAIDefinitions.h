...
enum class EOAChatEngineType : uint8
{
	...
	GPT_3_5_TURBO_1106 = 4 UMETA(ToolTip = "GPT-3.5 Turbo model with improved instruction following, JSON mode, reproducible outputs, parallel function calling, and more. Returns a maximum of 4,096 output tokens"),
